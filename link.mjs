...
const symlinkPath = path.resolve(dataPath, "modules", "immortal-ardor");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "immortal-ardor" ${atPath} already exists in the "systems" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
